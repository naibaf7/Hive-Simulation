...
\begin{figure}
	...
	\begin{tikzpicture}[node distance = 3cm and 3cm, auto]
		...
		\node [resource, right of=brood, node distance = 3.5cm] (food) {Food};
		\node [natural, right of=food, node distance = 3.5cm] (environment) {Environment};
	...
	\end{tikzpicture}} 
	\caption{\textit{Honey bee social dynamics and environmental influences covered by our advanced model.}}
