...
\subsection{Basic model: Hive simulation}
	...
	\subsection{Empirical data bases}
		...
		\subsubsection{Flower patches and food}
			...
			As remarked at the beginning of section \ref{chap:basicModel}, we simplify the complicated ageing process (larvae to hive bee) to 12 days. Mortality rate is set to 0.075 and thus slightly lower than the values of \textit{Khoury}. This will be discussed later in section \ref{chap:constantFoodDynamicLaying}.
			\\
